...
rotas.post('/instrutores/:id/aulas', aulas.adicionarAula)
rotas.get('/aulas', aulas.listarAulas)
rotas.get('/aulas/:idAula', aulas.encontrarAula)
rotas.get('/instrutores/:id/aulas', aulas.mostrarAulasDoInstrutor)
