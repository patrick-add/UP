...
A seguinte lista de pessoas, que se registraram em diferentes empresas em diferentes datas, ordenei essa lista dos registros mais antigos para os mais novos.
